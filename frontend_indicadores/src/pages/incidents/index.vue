  ...
  <v-container>
    <v-row class="mb-4">
      <v-col cols="12" md="12" class="d-flex align-center">
        ...
        <v-text-field v-model="search" prepend-inner-icon="mdi-magnify" label="Buscador rápido..." hide-details density="compact" variant="solo-filled" class="mr-2"></v-text-field>
    ...
    <v-dialog v-model="dialog" max-width="800" persistent>
      <v-card>
        ...
        <v-card-text class="pa-6">
          <v-form @submit.prevent="saveItem" ref="formRef" id="incidentForm">
        ...
        <v-card-actions class="pa-4">
          ...
          <v-btn color="primary" type="submit" form="incidentForm" :loading="saving">
